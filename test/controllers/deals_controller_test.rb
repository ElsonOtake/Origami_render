...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference("Deal.count") do
      post deals_url, params: { deal: { amount: @deal.amount, customer_id: @deal.customer_id, name: @deal.name } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { amount: @deal.amount, customer_id: @deal.customer_id, name: @deal.name } }
